...
public class EditCommand extends Command {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        seedu.address.model.person.Remark updatedRemark = editPersonDescriptor.getRemark().orElse(personToEdit.getRemark());
    ...
    public static class EditPersonDescriptor {
        ...
        public void setRemark(seedu.address.model.person.Remark remark) {
            this.remark = remark;
        }

        public Optional<seedu.address.model.person.Remark> getRemark() {
